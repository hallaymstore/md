...
const userSchema = new mongoose.Schema({
  ...
  position: { type: String, trim: true, maxlength: 140, default: '' },
  academicDegree: { type: String, trim: true, maxlength: 120, default: '' },
  academicTitle: { type: String, trim: true, maxlength: 120, default: '' },
  office: { type: String, trim: true, maxlength: 120, default: '' },
